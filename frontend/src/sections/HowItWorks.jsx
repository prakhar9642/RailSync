  ...
  return (
    ...
    >
      ...
      <motion.path
        ...
        initial={reduceMotion ? false : { pathLength: 0, opacity: 0 }}
        animate={{ pathLength: 1, opacity: 1 }}
        transition={{ duration: 0.35, delay: delay + 0.35, ease }}
      />
    </motion.svg>
  );
}
...
function CompletePipeline({ reduceMotion }) {
  return (
    ...
    >
      ...
      <FlowConnector delay={0.25} reduceMotion={reduceMotion} />
      <CompactStage stage={STAGES[2]} />
      <FlowConnector delay={0.65} reduceMotion={reduceMotion} />

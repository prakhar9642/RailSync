...
- `stations.json`, `sections.json`, and `train_occupancy.json` are `PUBLIC_TIMETABLE_DERIVED` from the official *Eastern Railway Combined Suburban Time Table No. 10*, valid 1 November 2017 through 30 June 2018.
